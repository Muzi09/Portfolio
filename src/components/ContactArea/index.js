                ...
                <div className="container">
                    <div className="row">
                        <div className="max-w-[640px] mx-auto text-center text-white mb-[60px] md:mb-[40px]">
                            ...
                            <p className="base-font text-lg font-normal">Let’s connect! Whether you have questions, need assistance, or want to collaborate on a project, I’m here to help and chat</p>
                        </div>
                    </div>
