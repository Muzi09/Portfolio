        ...
        <div className="relative w-full z-10 md:hidden">
            ...
            before:bg-no-repeat before:bg-center before:bg-cover before:-z-0">
                    <div className="grid grid-cols-2 gap-3 items-center relative z-20">
                        <h2 className="font-base-font font-bold text-[50px] leading-[60px] text-white xl:text-[45px] lg:text-[35px] lg:leading-[50px]">Send me a message, Lets's make something together</h2>
                    ...
                    before:absolute  before:content-['\f10d'] before:font-[Flaticon] before:right-[30px]
                     before:top-[50%] before:text-[14px] before:-translate-y-1/2" to="contact" spy={true} smooth={true} duration={500}>Contact Me</Link>
                        </div>
                    </div>
