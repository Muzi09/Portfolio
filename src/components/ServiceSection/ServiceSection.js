        ...
        <section className="section-wrap bg-[#191919] overflow-hidden z-50" id='service'>
            ...
            <div className="wraper sm:max-w-[540px] col:max-w[100%]">
                <div className="max-w-[640px] mx-auto text-center text-white mb-[60px] md:mb-[40px]">
                    <h2 className="heading-font font-bold text-5xl md:text-[35px] sm:text-[22px] mb-[15px]">"What I Do"
                    </h2>
                    <p className="base-font text-lg font-normal">I craft end-to-end web solutions, from intuitive UIs to scalable back-end systems. With a focus on functionality, efficiency, and design, I turn concepts into reality using modern web technologies</p>
                </div>
