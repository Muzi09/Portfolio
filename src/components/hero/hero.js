                ...
                <div className="wraper">
                    <div className="flex-1">
                        <div className="w-[660px] lg:w-[470px]   md:w-full  md:text-center">
                            ...
                            <p className="text-white text-[19px] capitalize font-normal leading-[33px] mb-[30px] col:text-[15px] col:leading-[28px] md:mx-[80px] col:mx-0">Your Vision, My Code. Let's Build the Future.</p>
